...
pageTranslations['project-one.html'] = {
  nl: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'Aurubis IT-ondersteuning' },
      '.project-hero h1': { text: 'IT-support in een productieomgeving' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Context: dit was mijn ervaring bij Aurubis Olen. Ik hielp met IT-support en troubleshooting in een echte productieomgeving waar betrouwbaarheid en duidelijke opvolging belangrijk zijn.' },
  ...
  en: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'Aurubis IT Support' },
      '.project-hero h1': { text: 'IT support in a production environment' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Context: this was my experience at Aurubis Olen. I helped with IT support and troubleshooting in a real production environment where reliability and clear follow-up mattered.' },
      '.hero-side-label': { text: 'Status' },
...
pageTranslations['project-two.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Context: dit is het project waaraan ik in semester 2 tot nu toe heb gewerkt. Het idee draait rond planning en gewoontevorming voor gezinnen, met focus op een duidelijke flow en een bruikbare mobiele ervaring.' },
  ...
  en: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'MissionZebra' },
      '.project-hero h1': { text: 'MissionZebra prototype' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Context: this is the project I worked on in semester 2 so far. The idea focuses on planning and habit building for families, with a clear flow and a usable mobile experience.' },
