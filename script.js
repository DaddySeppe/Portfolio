  ...
  'index.html': {
    nl: {
      ...
      selectors: {
        ...
        '.internship-panel h2': { text: 'Stage gezocht in softwareontwikkeling' },
        '.internship-panel .internship-lead': { text: 'Ik zoek een plek waar ik mag meebouwen aan echte apps of tools: code begrijpen, verbeteren, bugs oplossen en elke week zichtbare vooruitgang maken.' },
        '.internship-points div:nth-child(1) h3': { text: 'Wat je van mij krijgt' },
        '.internship-points div:nth-child(1) p': { text: 'Ik blijf rustig wanneer iets niet meteen werkt, zoek gericht verder en vraag door tot ik de logica snap.' },
        '.internship-points div:nth-child(2) h3': { text: 'Waar ik energie van krijg' },
        '.internship-points div:nth-child(2) p': { text: 'Software die niet alleen mooi oogt, maar ook echt een probleem oplost voor mensen die ermee werken.' },
        '.internship-points div:nth-child(3) h3': { text: 'Wat ik wil leren' },
        '.internship-points div:nth-child(3) p': { text: 'Meer verantwoordelijkheid nemen in een team, betere code schrijven en sneller keuzes durven maken.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.internship-panel h2': { text: 'Looking for a software development internship' },
        '.internship-panel .internship-lead': { text: 'I am looking for a place where I can help build real apps or tools: understand code, improve it, fix bugs, and make visible progress every week.' },
        '.internship-points div:nth-child(1) h3': { text: 'What you get from me' },
        '.internship-points div:nth-child(1) p': { text: 'I stay calm when something does not work right away, keep searching with focus, and ask questions until I understand the logic.' },
        '.internship-points div:nth-child(2) h3': { text: 'What gives me energy' },
        '.internship-points div:nth-child(2) p': { text: 'Software that does not only look good, but actually solves a problem for the people using it.' },
        '.internship-points div:nth-child(3) h3': { text: 'What I want to learn' },
        '.internship-points div:nth-child(3) p': { text: 'Taking more responsibility in a team, writing better code, and becoming more confident in technical choices.' },
  ...
  'about.html': {
    nl: {
      ...
      selectors: {
        ...
        '.experience-list .exp-item:nth-child(4) span': { text: 'Als iets niet werkt, zoek ik rustig uit waar het fout loopt en probeer ik een logische oplossing te vinden.' },
