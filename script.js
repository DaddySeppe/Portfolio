  ...
  'about.html': {
    nl: {
      ...
      selectors: {
        ...
        '.showcase-text h2': { text: 'Hoe ik werk en blijf bijleren' },
        '.showcase-text > p:not(.section-eyebrow)': { text: 'Ik combineer technische basiskennis met rustig nadenken, testen en stap voor stap verbeteren.' },
        '.experience-list .exp-item:nth-child(1) .exp-year': { text: 'CODE' },
        '.experience-list .exp-item:nth-child(1) strong': { text: 'Websites en interfaces bouwen' },
        '.experience-list .exp-item:nth-child(1) span': { text: "Ik werk graag aan duidelijke pagina's die logisch opgebouwd zijn en goed bruikbaar blijven." },
        '.experience-list .exp-item:nth-child(2) .exp-year': { text: 'DATA' },
        '.experience-list .exp-item:nth-child(2) strong': { text: 'Gegevens en back-end begrijpen' },
        '.experience-list .exp-item:nth-child(2) span': { text: 'Ik leer hoe data, databases en serverlogica samen een toepassing sterker maken.' },
        '.experience-list .exp-item:nth-child(3) .exp-year': { text: 'TEAM' },
        '.experience-list .exp-item:nth-child(3) strong': { text: 'Meedenken in projecten' },
        '.experience-list .exp-item:nth-child(3) span': { text: 'Ik luister, stel vragen en probeer oplossingen te vinden die voor het team werkbaar zijn.' },
        '.experience-list .exp-item:nth-child(4) .exp-year': { text: 'GROEI' },
        '.experience-list .exp-item:nth-child(4) strong': { text: 'Rustig verbeteren' },
        '.experience-list .exp-item:nth-child(4) span': { text: 'Ik werk stap voor stap, test wat ik maak en leer bij uit fouten of feedback.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.showcase-text h2': { text: 'How I work and keep learning' },
        '.showcase-text > p:not(.section-eyebrow)': { text: 'I combine technical basics with calm thinking, testing, and step-by-step improvement.' },
        '.experience-list .exp-item:nth-child(1) .exp-year': { text: 'CODE' },
        '.experience-list .exp-item:nth-child(1) strong': { text: 'Building websites and interfaces' },
        '.experience-list .exp-item:nth-child(1) span': { text: 'I like working on clear pages that are structured logically and remain easy to use.' },
        '.experience-list .exp-item:nth-child(2) .exp-year': { text: 'DATA' },
        '.experience-list .exp-item:nth-child(2) strong': { text: 'Understanding data and back-end' },
        '.experience-list .exp-item:nth-child(2) span': { text: 'I am learning how data, databases, and server logic make an application stronger.' },
        '.experience-list .exp-item:nth-child(3) .exp-year': { text: 'TEAM' },
        '.experience-list .exp-item:nth-child(3) strong': { text: 'Thinking along in projects' },
        '.experience-list .exp-item:nth-child(3) span': { text: 'I listen, ask questions, and try to find solutions that work well for the team.' },
        '.experience-list .exp-item:nth-child(4) .exp-year': { text: 'GROW' },
        '.experience-list .exp-item:nth-child(4) strong': { text: 'Improving calmly' },
        '.experience-list .exp-item:nth-child(4) span': { text: 'I work step by step, test what I make, and learn from mistakes or feedback.' },
