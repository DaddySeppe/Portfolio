  ...
  'index.html': {
    nl: {
      ...
      selectors: {
        ...
        '.neo-card:nth-child(4) p': { text: 'Semester 1, first project: een Figma-websiteconcept voor een fictieve klant.' },
        '.neo-card:nth-child(5) h3': { text: 'K.V.V Rauw' },
        '.neo-card:nth-child(5) p': { text: 'Semester 2, second project: een prototype omzetten naar een werkende website.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.neo-card:nth-child(4) h3': { text: 'Poutrel' },
        '.neo-card:nth-child(4) p': { text: 'Semester 1, first project: a Figma website concept for a fictional client.' },
        '.neo-card:nth-child(5) h3': { text: 'K.V.V Rauw' },
        '.neo-card:nth-child(5) p': { text: 'Semester 2, second project: converting a prototype into a working website.' },
  ...
  'projects.html': {
    nl: {
      ...
      selectors: {
        ...
        '.hub-card:nth-child(4) p': { text: 'Semester 1, first project: een Figma-websiteconcept voor een fictieve klant.' },
        '.hub-card:nth-child(5) h3': { text: 'K.V.V Rauw' },
        '.hub-card:nth-child(5) p': { text: 'Semester 2, second project: een prototype omzetten naar een werkende website.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.hub-card:nth-child(4) h3': { text: 'Poutrel' },
        '.hub-card:nth-child(4) p': { text: 'Semester 1, first project: a Figma website concept for a fictional client.' },
        '.hub-card:nth-child(5) h3': { text: 'K.V.V Rauw' },
        '.hub-card:nth-child(5) p': { text: 'Semester 2, second project: converting a prototype into a working website.' },
        '.hub-card:nth-child(1) span': { text: 'Open Project' },
        '.hub-card:nth-child(2) span': { text: 'Open Project' },
        '.hub-card:nth-child(3) span': { text: 'Open Project' },
        '.hub-card:nth-child(4) span': { text: 'Open Project' },
