  ...
  'index.html': {
    nl: {
      ...
      selectors: {
        ...
        '.neo-text': { text: 'Ik ben een tweedejaarsstudent APP/AI en maak graag dingen die ook echt werken.\n\nIk ben iemand die graag bijleert door te doen. Via projecten zoals MissionZebra, mijn portfolio en mijn ervaring met IT-ondersteuning bij Aurubis leer ik stap voor stap hoe ik ideeën kan omzetten in duidelijke en praktische oplossingen. Ik denk graag mee, zoek naar oplossingen wanneer iets niet meteen lukt en vind het belangrijk dat wat ik maak bruikbaar is voor anderen.' },
        ...
        '.neo-side .neo-panel:nth-child(1) h2': { text: 'Actief op Zoek naar Stage' },
        '.neo-side .neo-panel:nth-child(1) p': { text: 'Klaar om groeien in web, support of development. Ik ben rustig, logisch en lever af.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.neo-text': { text: 'I am a second-year APP/AI student and I enjoy making things that actually work.\n\nI am someone who likes learning by doing. Through projects such as MissionZebra, my portfolio, and my experience with IT support at Aurubis, I am learning step by step how to turn ideas into clear and practical solutions. I like thinking along, looking for solutions when something does not work right away, and I find it important that what I make is useful for others.' },
        ...
        '.neo-side .neo-panel:nth-child(1) h2': { text: 'Actively Looking for Internship' },
        '.neo-side .neo-panel:nth-child(1) p': { text: 'Ready to grow in web, support, or development. I think clearly, solve problems, deliver results.' },
