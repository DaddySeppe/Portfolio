...
pageTranslations['project-one.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Tijdens mijn stage bij Aurubis werkte ik mee aan software die een tablet blankt wanneer een voertuig in beweging is.' },
      ...
      '.project-impact-grid article:nth-child(1) h3': { text: 'Programma' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Ik werkte mee aan een programma voor screen blanking op tablets in voertuigen.' },
  ...
  en: {
    ...
    selectors: {
      ...
      '.project-hero h1': { text: 'Aurubis Screen Blanking' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'During my internship at Aurubis, I helped build software that blanks a tablet when a vehicle is moving.' },
      '.hero-side-label': { text: 'Focus' },
      ...
      '.project-impact-grid article:nth-child(1) h3': { text: 'Program' },
      '.project-impact-grid article:nth-child(1) p': { text: 'I helped build a program for screen blanking on tablets in vehicles.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Screen blanking' },
