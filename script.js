...
pageTranslations['cv.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.cv-name-title p': { text: 'IT student' },
      '.cv-about h3': { text: 'About Me' },
      '.cv-about p': { text: 'Gemotiveerde APP/AI-student met interesse in webontwikkeling en praktische IT-support. Ik werk rustig, leer graag bij en probeer oplossingen te maken die duidelijk en bruikbaar zijn.' },
      '.cv-sidebar .cv-block:nth-child(2) h3': { text: 'Info' },
      '.cv-sidebar .cv-block:nth-child(3) h3': { text: 'Skills' },
      '.cv-sidebar .cv-block:nth-child(4) h3': { text: 'Projects' },
      '.cv-content .cv-section:nth-child(1) h3': { text: 'Student Job / Stage' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(2) strong': { text: 'Aurubis Olen - 2023-2024' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(3) strong': { text: 'MissionZebra - Teamproject' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(3) p': { text: 'Mobiele app rond planning en gewoontes, met focus op analyse, samenwerking en duidelijke schermen.' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(4) strong': { text: 'Portfolio website' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(4) p': { text: "Eigen website gebouwd met HTML, CSS en JavaScript om mijn projecten, CV en contactgegevens te tonen." },
      '.cv-content .cv-section:nth-child(2) h3': { text: 'Education' },
      '.cv-content .cv-section:nth-child(2) .cv-entry:nth-child(1) p': { text: 'APP/AI - 2024-2027' },
      '.cv-content .cv-section:nth-child(2) .cv-entry:nth-child(2) p': { text: 'IT & Networks - 2017-2023' }
    }
  },
  en: {
    title: 'Seppe | CV',
    selectors: {
      ...
      '.cv-name-title p': { text: 'IT student' },
      '.cv-about h3': { text: 'About Me' },
      '.cv-about p': { text: 'Motivated APP/AI student with an interest in web development and practical IT support. I work calmly, like to keep learning, and try to make solutions that are clear and usable.' },
      '.cv-sidebar .cv-block:nth-child(2) h3': { text: 'Info' },
      '.cv-sidebar .cv-block:nth-child(3) h3': { text: 'Skills' },
      '.cv-sidebar .cv-block:nth-child(4) h3': { text: 'Projects' },
      '.cv-content .cv-section:nth-child(1) h3': { text: 'Student Job / Internship' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(2) strong': { text: 'Aurubis Olen - 2023-2024' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(3) strong': { text: 'MissionZebra - Team project' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(3) p': { text: 'Mobile app around planning and habits, with focus on analysis, collaboration, and clear screens.' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(4) strong': { text: 'Portfolio website' },
      '.cv-content .cv-section:nth-child(1) .cv-entry:nth-child(4) p': { text: 'Own website built with HTML, CSS, and JavaScript to show my projects, CV, and contact details.' },
      '.cv-content .cv-section:nth-child(2) h3': { text: 'Education' },
      '.cv-content .cv-section:nth-child(2) .cv-entry:nth-child(1) p': { text: 'APP/AI - 2024-2027' },
      '.cv-content .cv-section:nth-child(2) .cv-entry:nth-child(2) p': { text: 'IT & Networks - 2017-2023' }
    }
