  ...
  'index.html': {
    nl: {
      ...
      selectors: {
        ...
        '.internship-panel .internship-lead': { text: 'Ik zoek een stage waar ik kan meewerken aan echte software: features bouwen, bugs oplossen, code verbeteren en leren van ervaren developers.' },
        '.internship-points div:nth-child(1) h3': { text: 'Focus' },
        '.internship-points div:nth-child(1) p': { text: "Webapps, praktische tools, API's en duidelijke user flows." },
        '.internship-points div:nth-child(2) h3': { text: 'Bijdrage' },
        '.internship-points div:nth-child(2) p': { text: 'Ik test wat ik maak, werk gestructureerd en wil feedback direct omzetten in betere code.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.internship-panel .internship-lead': { text: 'I am looking for an internship where I can work on real software: build features, fix bugs, improve code, and learn from experienced developers.' },
        '.internship-points div:nth-child(1) h3': { text: 'Focus' },
        '.internship-points div:nth-child(1) p': { text: 'Web apps, practical tools, APIs, and clear user flows.' },
        '.internship-points div:nth-child(2) h3': { text: 'Contribution' },
        '.internship-points div:nth-child(2) p': { text: 'I test what I build, work in a structured way, and want to turn feedback directly into better code.' },
