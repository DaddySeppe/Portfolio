...
pageTranslations['project-one.html'] = {
  nl: {
    title: 'Seppe | Aurubis Screen Blanking',
    selectors: {
      '.project-hero .eyebrow': { text: 'Stageproject' },
      '.project-hero h1': { text: 'Aurubis Screen Blanking' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Tijdens mijn stage bij Aurubis werkte ik aan een screen blanking project voor rijdende voertuigen op de site, met focus op veiligheid, duidelijk gebruik en betrouwbaarheid.' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Voertuigen op de site' },
      '.hero-facts li:nth-child(1)': { html: '<span>Rol</span> Stagiair' },
      '.hero-facts li:nth-child(2)': { html: '<span>Context</span> Aurubis Olen' },
      '.hero-facts li:nth-child(3)': { html: '<span>Focus</span> Screen blanking' },
      '.project-impact .eyebrow': { text: 'Realisaties' },
      '.project-impact h2': { text: 'Wat dit project inhield' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Analyse' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Ik onderzocht hoe screen blanking kon helpen bij rijdende voertuigen op de site.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Veiligheid' },
      '.project-impact-grid article:nth-child(2) p': { text: 'De oplossing moest duidelijk en betrouwbaar zijn binnen een operationele omgeving.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Praktijk' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Ik leerde werken met echte beperkingen, verwachtingen en opvolging op een bedrijfssite.' },
      '.project-flow .eyebrow': { text: 'Wat ik leerde' },
      '.project-flow h2': { text: 'Leerpunten uit de praktijk' },
      '.project-steps li:nth-child(1)': { html: '<strong>Analyse</strong> technische vragen vertalen naar een haalbare oplossing.' },
      '.project-steps li:nth-child(2)': { html: '<strong>Veiligheid</strong> rekening houden met rijdende voertuigen en gebruik op de site.' },
      ...
      '.portfolio-section:last-child h2': { text: 'Waar ik zelf aan werkte' },
      '.portfolio-section:last-child .project-copy': { text: 'Ik werkte mee aan het screen blanking project en leerde hoe je een technische oplossing afstemt op een echte werkomgeving.' },
  ...
  en: {
    title: 'Seppe | Aurubis Screen Blanking',
    selectors: {
      '.project-hero .eyebrow': { text: 'Internship project' },
      '.project-hero h1': { text: 'Aurubis Screen Blanking' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'During my internship at Aurubis, I worked on a screen blanking project for moving vehicles on site, focused on safety, clear use, and reliability.' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Vehicles on site' },
      '.hero-facts li:nth-child(1)': { html: '<span>Role</span> Intern' },
      '.hero-facts li:nth-child(2)': { html: '<span>Context</span> Aurubis Olen' },
      '.hero-facts li:nth-child(3)': { html: '<span>Focus</span> Screen blanking' },
      '.project-impact .eyebrow': { text: 'Realizations' },
      '.project-impact h2': { text: 'What this project involved' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Analysis' },
      '.project-impact-grid article:nth-child(1) p': { text: 'I researched how screen blanking could help with moving vehicles on site.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Safety' },
      '.project-impact-grid article:nth-child(2) p': { text: 'The solution had to be clear and reliable within an operational environment.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Practice' },
      '.project-impact-grid article:nth-child(3) p': { text: 'I learned to work with real constraints, expectations, and follow-up on a company site.' },
      '.project-flow .eyebrow': { text: 'What I learned' },
      '.project-flow h2': { text: 'Learning points from practice' },
      '.project-steps li:nth-child(1)': { html: '<strong>Analysis</strong> translate technical questions into a feasible solution.' },
      '.project-steps li:nth-child(2)': { html: '<strong>Safety</strong> consider moving vehicles and use on site.' },
      ...
      '.portfolio-section:last-child h2': { text: 'What I worked on' },
      '.portfolio-section:last-child .project-copy': { text: 'I contributed to the screen blanking project and learned how to align a technical solution with a real work environment.' },
  ...
  'index.html': {
    nl: {
      ...
      selectors: {
        ...
        '.neo-card:nth-child(1) h3': { text: 'Aurubis Screen Blanking' },
        '.neo-card:nth-child(1) p': { text: 'Een stageproject rond screen blanking voor rijdende voertuigen op de site.' },
        ...
        '.neo-card:nth-child(3) p': { text: 'Een skill-project waarin we voor een klant een volledige website/applicatie hebben gebouwd.' },
        ...
        '.neo-card:nth-child(5) p': { text: 'Mijn eigen portfolio waarin ik mijn profiel, projecten, CV en groei duidelijk samenbreng.' },
        '.neo-card:nth-child(6) h3': { text: 'Helpse' },
        '.neo-card:nth-child(6) p': { text: 'Een kanaal waar studenten mensen in de buurt kunnen helpen met klusjes tegen betaling.' },
        ...
        '.internship-points div:nth-child(1) h3': { text: 'Waar ik aan wil werken' },
        '.internship-points div:nth-child(1) p': { text: "Features uitwerken, bugs analyseren, database queries schrijven, API's koppelen en code stap voor stap verbeteren." },
        '.internship-points div:nth-child(2) h3': { text: 'Wat ik wil leren' },
        '.internship-points div:nth-child(2) p': { text: 'Werken in een echte codebase, Git correct gebruiken, testen schrijven en technische keuzes beter begrijpen.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.neo-card:nth-child(1) h3': { text: 'Aurubis Screen Blanking' },
        '.neo-card:nth-child(1) p': { text: 'An internship project around screen blanking for moving vehicles on site.' },
        '.neo-card:nth-child(2) h3': { text: 'MissionZebra' },
        '.neo-card:nth-child(2) p': { text: 'An app that helps children learn to manage screen time and improves family life.' },
        '.neo-card:nth-child(3) h3': { text: 'Poetrel' },
        '.neo-card:nth-child(3) p': { text: 'A skill project where we built a complete website/application for a client.' },
        '.neo-card:nth-child(4) h3': { text: 'K.V.V Rauw' },
        '.neo-card:nth-child(4) p': { text: 'A skill project where we built a complete website/application for a client.' },
        '.neo-card:nth-child(5) h3': { text: 'Portfolio Website' },
        '.neo-card:nth-child(5) p': { text: 'My own portfolio where I bring together my profile, projects, CV, and growth clearly.' },
        '.neo-card:nth-child(6) h3': { text: 'Helpse' },
        '.neo-card:nth-child(6) p': { text: 'A channel where students can help people nearby with paid small jobs.' },
        ...
        '.internship-points div:nth-child(1) h3': { text: 'What I want to work on' },
        '.internship-points div:nth-child(1) p': { text: 'Building features, analyzing bugs, writing database queries, connecting APIs, and improving code step by step.' },
        '.internship-points div:nth-child(2) h3': { text: 'What I want to learn' },
        '.internship-points div:nth-child(2) p': { text: 'Working in a real codebase, using Git properly, writing tests, and understanding technical choices better.' },
  ...
  'about.html': {
    nl: {
      ...
      selectors: {
        ...
        '.skills-matrix .skill-card-large:nth-child(1) p': { text: 'Ik hou van fitness, fietsen, muziek ontdekken en kleine technische experimenten.' },
        '.skills-matrix .skill-card-large:nth-child(2) h3': { text: 'Waarom APP/AI' },
        '.skills-matrix .skill-card-large:nth-child(2) p': { text: 'Ik kies voor APP/AI omdat ik graag applicaties bouw en systemen begrijp.' },
        '.skills-matrix .skill-card-large:nth-child(3) h3': { text: 'Na mijn studies' },
        '.skills-matrix .skill-card-large:nth-child(3) p': { text: 'Ik wil doorgroeien naar een rol waarin ik software, support of infrastructuur combineer.' },
        '.skills-matrix .skill-card-large:nth-child(4) h3': { text: 'CV' },
        '.skills-matrix .skill-card-large:nth-child(4) p': { text: 'Mijn CV staat apart op een eigen pagina en is daar meteen beschikbaar.' },
        ...
        '.showcase-text > p:not(.section-eyebrow)': { text: 'Ik leer het meest door dingen uit te proberen, fouten op te lossen en daarna te verbeteren.' },
        '.experience-list .exp-item:nth-child(1) .exp-year': { text: 'WEB' },
        '.experience-list .exp-item:nth-child(1) strong': { text: 'Websites maken' },
        '.experience-list .exp-item:nth-child(1) span': { text: "Ik vind het leuk om pagina's te bouwen die er verzorgd uitzien en duidelijk werken." },
        '.experience-list .exp-item:nth-child(2) .exp-year': { text: 'APP' },
        '.experience-list .exp-item:nth-child(2) strong': { text: 'Applicaties begrijpen' },
        '.experience-list .exp-item:nth-child(2) span': { text: 'Ik wil snappen hoe een toepassing in elkaar zit, van scherm tot database.' },
        '.experience-list .exp-item:nth-child(3) .exp-year': { text: 'TEAM' },
        '.experience-list .exp-item:nth-child(3) strong': { text: 'Samen aan iets werken' },
        '.experience-list .exp-item:nth-child(3) span': { text: 'Ik denk graag mee, luister naar feedback en probeer mijn deel duidelijk af te werken.' },
        '.experience-list .exp-item:nth-child(4) .exp-year': { text: 'HELP' },
        '.experience-list .exp-item:nth-child(4) strong': { text: 'Problemen oplossen' },
        '.experience-list .exp-item:nth-child(4) span': { text: 'Als iets niet werkt, zoek ik uit waar het fout loopt en probeer ik een logische oplossing te vinden.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.skills-matrix .skill-card-large:nth-child(1) p': { text: 'I enjoy fitness, cycling, discovering music, and small technical experiments.' },
        '.skills-matrix .skill-card-large:nth-child(2) h3': { text: 'Why APP/AI' },
        '.skills-matrix .skill-card-large:nth-child(2) p': { text: 'I chose APP/AI because I like building applications and understanding systems.' },
        '.skills-matrix .skill-card-large:nth-child(3) h3': { text: 'After my studies' },
        '.skills-matrix .skill-card-large:nth-child(3) p': { text: 'I want to grow into a role where I combine software, support, or infrastructure.' },
        '.skills-matrix .skill-card-large:nth-child(4) h3': { text: 'CV' },
        '.skills-matrix .skill-card-large:nth-child(4) p': { text: 'My CV has its own page and is available there right away.' },
        ...
        '.showcase-text > p:not(.section-eyebrow)': { text: 'I learn the most by trying things out, fixing mistakes, and improving afterwards.' },
        '.experience-list .exp-item:nth-child(1) .exp-year': { text: 'WEB' },
        '.experience-list .exp-item:nth-child(1) strong': { text: 'Making websites' },
        '.experience-list .exp-item:nth-child(1) span': { text: 'I enjoy building pages that look clean and work clearly.' },
        '.experience-list .exp-item:nth-child(2) .exp-year': { text: 'APP' },
        '.experience-list .exp-item:nth-child(2) strong': { text: 'Understanding applications' },
        '.experience-list .exp-item:nth-child(2) span': { text: 'I want to understand how an application fits together, from screen to database.' },
        '.experience-list .exp-item:nth-child(3) .exp-year': { text: 'TEAM' },
        '.experience-list .exp-item:nth-child(3) strong': { text: 'Working on something together' },
        '.experience-list .exp-item:nth-child(3) span': { text: 'I like thinking along, listening to feedback, and finishing my part clearly.' },
        '.experience-list .exp-item:nth-child(4) .exp-year': { text: 'HELP' },
        '.experience-list .exp-item:nth-child(4) strong': { text: 'Solving problems' },
        '.experience-list .exp-item:nth-child(4) span': { text: 'When something does not work, I calmly look for what goes wrong and try to find a logical solution.' },
  ...
  'projects.html': {
    nl: {
      ...
      selectors: {
        ...
        '.hub-card:nth-child(1) h3': { text: 'Aurubis Screen Blanking' },
        '.hub-card:nth-child(1) p': { text: 'Een stageproject rond screen blanking voor rijdende voertuigen op de site.' },
        ...
        '.hub-card:nth-child(3) p': { text: 'Een skill-project waarin we voor een klant een volledige website/applicatie hebben gebouwd.' },
        ...
        '.hub-card:nth-child(5) p': { text: 'Mijn eigen portfolio waarin ik mijn profiel, projecten, CV en groei duidelijk samenbreng.' },
        '.hub-card:nth-child(6) h3': { text: 'Helpse' },
        '.hub-card:nth-child(6) p': { text: 'Een kanaal waar studenten mensen in de buurt kunnen helpen met klusjes tegen betaling.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.hub-card:nth-child(1) h3': { text: 'Aurubis Screen Blanking' },
        '.hub-card:nth-child(1) p': { text: 'An internship project around screen blanking for moving vehicles on site.' },
        '.hub-card:nth-child(2) h3': { text: 'MissionZebra' },
        '.hub-card:nth-child(2) p': { text: 'An app that helps children learn to manage screen time and improves family life.' },
        '.hub-card:nth-child(3) h3': { text: 'Poetrel' },
        '.hub-card:nth-child(3) p': { text: 'A skill project where we built a complete website/application for a client.' },
        '.hub-card:nth-child(4) h3': { text: 'K.V.V Rauw' },
        '.hub-card:nth-child(4) p': { text: 'A skill project where we built a complete website/application for a client.' },
        '.hub-card:nth-child(5) h3': { text: 'Portfolio Website' },
        '.hub-card:nth-child(5) p': { text: 'My own portfolio where I bring together my profile, projects, CV, and growth clearly.' },
        '.hub-card:nth-child(6) h3': { text: 'Helpse' },
        '.hub-card:nth-child(6) p': { text: 'A channel where students can help people nearby with paid small jobs.' },
        '.hub-card:nth-child(1) span': { text: 'Open Project' },
        '.hub-card:nth-child(2) span': { text: 'Open Project' },
        '.hub-card:nth-child(3) span': { text: 'Open Project' },
        '.hub-card:nth-child(4) span': { text: 'Open Project' },
  ...
  'contact.html': {
    nl: {
      ...
      selectors: {
        ...
        '.hub-hero .hero-main > p:not(.eyebrow)': { text: 'Heb je een vraag, stagevoorstel of projectidee? Stuur gerust een bericht en ik antwoord zo snel mogelijk.' },
        ...
        '.contact-form-head p:not(.eyebrow)': { text: 'Vertel kort waarvoor je mij wilt contacteren, dan neem ik via e-mail terug contact op.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.hub-hero .hero-main > p:not(.eyebrow)': { text: 'Do you have a question, internship idea, or project proposal? Send me a message and I will reply as soon as I can.' },
        ...
        '.contact-form-head p:not(.eyebrow)': { text: 'Briefly tell me why you want to get in touch, and I will reply by email.' },
...
pageTranslations['project-two.html'] = {
  nl: {
    title: 'Seppe | MissionZebra',
    selectors: {
      '.project-hero .eyebrow': { text: 'MissionZebra' },
      '.project-hero h1': { text: 'MissionZebra prototype' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'MissionZebra is een app die kinderen leert omgaan met schermtijd en tegelijk helpt om het gezinsleven binnen families beter te organiseren.' },
      '.hero-tags span:nth-child(1)': { text: 'Teamproject' },
      '.hero-tags span:nth-child(2)': { text: 'Mobile-first' },
      '.hero-tags span:nth-child(3)': { text: 'Schermtijd' },
      '.hero-side-label': { text: 'Status' },
      '.hero-side h3': { text: 'Verder uitgewerkt' },
      '.hero-facts li:nth-child(1)': { html: '<span>Rol</span> Teamlid' },
      '.hero-facts li:nth-child(2)': { html: '<span>Focus</span> Kinderen en gezinnen' },
      '.hero-facts li:nth-child(3)': { html: '<span>Vak</span> SKIL2 - semester 2' },
      '.project-impact .eyebrow': { text: 'Realisaties' },
      '.project-impact h2': { text: 'Wat er al klaar is' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Schermtijd' },
      '.project-impact-grid article:nth-child(1) p': { text: 'We dachten na over hoe kinderen op een gezonde manier met schermtijd kunnen omgaan.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Gezinsleven' },
      '.project-impact-grid article:nth-child(2) p': { text: 'De app ondersteunt ouders en kinderen met duidelijke afspraken en een praktische flow.' },
  ...
  en: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'MissionZebra' },
      '.project-hero h1': { text: 'MissionZebra prototype' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'MissionZebra is an app that helps children learn to manage screen time and helps improve family life.' },
      '.hero-tags span:nth-child(1)': { text: 'Team project' },
      '.hero-tags span:nth-child(2)': { text: 'Mobile-first' },
      '.hero-tags span:nth-child(3)': { text: 'Screen time' },
      '.hero-side-label': { text: 'Status' },
      '.hero-side h3': { text: 'Further developed' },
      '.hero-facts li:nth-child(1)': { html: '<span>Role</span> Team member' },
      '.hero-facts li:nth-child(2)': { html: '<span>Focus</span> Children and families' },
      '.hero-facts li:nth-child(3)': { html: '<span>Course</span> SKIL2 - semester 2' },
      '.project-impact .eyebrow': { text: 'Realizations' },
      '.project-impact h2': { text: 'What is already finished' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Screen time' },
      '.project-impact-grid article:nth-child(1) p': { text: 'We thought about how children can handle screen time in a healthier way.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Family life' },
      '.project-impact-grid article:nth-child(2) p': { text: 'The app supports parents and children with clear agreements and a practical flow.' },
...
pageTranslations['project-three.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-flow h2': { text: 'Leerpunten uit de praktijk' },
      '.project-steps li:nth-child(1)': { html: '<strong>Analyse</strong> problemen gericht onderzoeken door naar de oorzaak te kijken in plaats van enkel naar het symptoom.' },
...
pageTranslations['project-three.html'] = pageTranslations['project-one.html'];
...
pageTranslations['project-poetrel.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Website/applicatie voor een klant' },
      '.project-impact .eyebrow': { text: 'Aanpak' },
      '.project-impact h2': { text: 'Wat dit project toont' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Klantvraag' },
      '.project-impact-grid article:nth-child(1) p': { text: 'De noden van de klant vertalen naar een duidelijke digitale oplossing.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Realisatie' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Een volledige website/applicatie opbouwen met aandacht voor structuur en gebruik.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Teamwerk' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Samen keuzes maken, taken verdelen en stap voor stap opleveren.' },
  ...
  en: {
    ...
    selectors: {
      ...
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Website/application for a client' },
      '.project-impact .eyebrow': { text: 'Approach' },
      '.project-impact h2': { text: 'What this project shows' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Client needs' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Translating the client needs into a clear digital solution.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Realization' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Building a complete website/application with attention to structure and use.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Teamwork' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Making choices together, dividing tasks, and delivering step by step.' },
...
pageTranslations['project-kvv-rauw.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'K.V.V Rauw is een skill-project waarin we voor een klant een volledige website/applicatie hebben gebouwd.' },
      '.hero-tags span:nth-child(1)': { text: 'Klantproject' },
      '.hero-tags span:nth-child(2)': { text: 'Website/applicatie' },
      ...
      '.project-impact-grid article:nth-child(1) h3': { text: 'Klantvraag' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Nadenken over wat de klant en gebruikers echt nodig hebben.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Structuur' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Informatie en functies opdelen zodat de applicatie logisch blijft.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Afwerking' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Een website/applicatie maken die betrouwbaar en overzichtelijk aanvoelt.' },
      '.panel-actions .btn-link': { text: 'Terug naar Projecten' }
    }
  },
  en: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'Skill project' },
      '.project-hero h1': { text: 'K.V.V Rauw' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'K.V.V Rauw is a skill project where we built a complete website/application for a client.' },
      '.hero-tags span:nth-child(1)': { text: 'Client project' },
      '.hero-tags span:nth-child(2)': { text: 'Website/application' },
      ...
      '.project-impact-grid article:nth-child(1) h3': { text: 'Client needs' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Thinking about what the client and users actually need.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Structure' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Splitting information and functions so the application stays logical.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Polish' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Creating a website/application that feels reliable and easy to scan.' },
      '.panel-actions .btn-link': { text: 'Back to Projects' }
    }
  }
};
...
pageTranslations['project-helpse.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Helpse is een kanaal waar studenten mensen in de buurt kunnen helpen met klusjes tegen betaling.' },
      '.hero-tags span:nth-child(1)': { text: 'Studenten' },
      '.hero-tags span:nth-child(2)': { text: 'Klusjes' },
      '.hero-tags span:nth-child(3)': { text: 'Betaling' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Hulp in de buurt' },
      '.project-impact .eyebrow': { text: 'Aanpak' },
      '.project-impact h2': { text: 'Wat dit project onderzoekt' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Vraag en aanbod' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Mensen met klusjes verbinden met studenten uit de buurt.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Betaling' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Het concept houdt rekening met klusjes die tegen betaling uitgevoerd worden.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Flow' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Nadenken over schermen, afspraken en duidelijke stappen voor beide kanten.' },
      '.panel-actions .btn-link': { text: 'Terug naar Projecten' }
    }
  },
  en: {
    ...
    selectors: {
      ...
      '.project-hero h1': { text: 'Helpse' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Helpse is a channel where students can help people nearby with paid small jobs.' },
      '.hero-tags span:nth-child(1)': { text: 'Students' },
      '.hero-tags span:nth-child(2)': { text: 'Small jobs' },
      '.hero-tags span:nth-child(3)': { text: 'Payment' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Help nearby' },
      '.project-impact .eyebrow': { text: 'Approach' },
      '.project-impact h2': { text: 'What this project explores' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Supply and demand' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Connecting people with small jobs to students nearby.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Payment' },
      '.project-impact-grid article:nth-child(2) p': { text: 'The concept accounts for small jobs being done for payment.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Flow' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Thinking about screens, agreements, and clear steps for both sides.' },
      '.panel-actions .btn-link': { text: 'Back to Projects' }
    }
  }
};
