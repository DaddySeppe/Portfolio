...
pageTranslations['project-poetrel.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Poutrel is een skill-project waarin we een website ontwierpen en ontwikkelden voor een fictieve klant.' },
      ...
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Van Figma naar website' },
      '.project-impact .eyebrow': { text: 'Aanpak' },
      '.project-impact h2': { text: 'Van klantidee naar webdesign' },
      ...
      '.project-impact-grid article:nth-child(3) h3': { text: 'Website' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Daarna bouwden we het ontwerp om tot een werkende, overzichtelijke website.' },
  ...
  en: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'Skill project' },
      '.project-hero h1': { text: 'Poutrel' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Poutrel is a skill project where we designed and developed a website for a fictional client.' },
      '.hero-tags span:nth-child(1)': { text: 'Fictional client' },
      '.hero-tags span:nth-child(2)': { text: 'Figma' },
      '.hero-tags span:nth-child(3)': { text: 'Website' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'From Figma to website' },
      '.project-impact .eyebrow': { text: 'Approach' },
      '.project-impact h2': { text: 'From client idea to web design' },
      ...
      '.project-impact-grid article:nth-child(3) h3': { text: 'Website' },
      '.project-impact-grid article:nth-child(3) p': { text: 'After that, we turned the design into a working and easy-to-scan website.' },
