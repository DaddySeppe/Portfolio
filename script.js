...
pageTranslations['project-one.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Over dit project mag ik niet te veel details delen, maar ik werkte mee aan software die een tablet blankt wanneer een voertuig in beweging is.' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Tablet blanking bij beweging' },
      ...
      '.project-impact h2': { text: 'Wat ik hierover kan delen' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Vertrouwelijk' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Door de bedrijfscontext kan ik enkel de algemene werking en mijn leerpunten delen.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Screen blanking' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Ik schreef mee aan een programma dat het tabletscherm blankt wanneer een voertuig beweegt.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Praktijk' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Ik leerde werken aan software die betrouwbaar moet zijn in een echte industriële omgeving.' },
      '.project-flow .eyebrow': { text: 'Wat ik leerde' },
      '.project-flow h2': { text: 'Leerpunten uit de praktijk' },
      '.project-steps li:nth-child(1)': { html: '<strong>Confidentialiteit:</strong> professioneel omgaan met informatie die niet publiek gedeeld mag worden.' },
      '.project-steps li:nth-child(2)': { html: '<strong>Veiligheid:</strong> rekening houden met voertuigen in beweging en gebruik op de site.' },
      '.project-steps li:nth-child(3)': { html: '<strong>Software in praktijk:</strong> meewerken aan een oplossing die in een echte werkomgeving gebruikt wordt.' },
      '.portfolio-section:last-child .eyebrow': { text: 'Mijn deel' },
      '.portfolio-section:last-child h2': { text: 'Waar ik zelf aan werkte' },
      '.portfolio-section:last-child .project-copy': { text: 'Ik werkte mee aan het screen blanking programma voor tablets in voertuigen. Wanneer het voertuig beweegt, wordt het scherm geblankt zodat de oplossing past binnen de veiligheidscontext van de site.' },
  ...
  en: {
    ...
    selectors: {
      ...
      '.project-hero h1': { text: 'Aurubis Screen Blanking' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'I cannot share many details about this project, but I helped build software that blanks a tablet when a vehicle is moving.' },
      '.hero-side-label': { text: 'Focus' },
      '.hero-side h3': { text: 'Tablet blanking while moving' },
      '.hero-facts li:nth-child(1)': { html: '<span>Role</span> Intern' },
      '.hero-facts li:nth-child(2)': { html: '<span>Context</span> Aurubis Olen' },
      '.hero-facts li:nth-child(3)': { html: '<span>Focus</span> Screen blanking' },
      '.project-impact .eyebrow': { text: 'Realizations' },
      '.project-impact h2': { text: 'What I can share' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Confidential' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Because of the company context, I can only share the general idea and my learning points.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Screen blanking' },
      '.project-impact-grid article:nth-child(2) p': { text: 'I helped write a program that blanks the tablet screen when a vehicle is moving.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Practice' },
      '.project-impact-grid article:nth-child(3) p': { text: 'I learned to work on software that has to be reliable in a real industrial environment.' },
      '.project-flow .eyebrow': { text: 'What I learned' },
      '.project-flow h2': { text: 'Learning points from practice' },
      '.project-steps li:nth-child(1)': { html: '<strong>Confidentiality:</strong> handle information professionally when it cannot be shared publicly.' },
      '.project-steps li:nth-child(2)': { html: '<strong>Safety:</strong> account for moving vehicles and use on site.' },
      '.project-steps li:nth-child(3)': { html: '<strong>Software in practice:</strong> contribute to a solution used in a real work environment.' },
      '.portfolio-section:last-child .eyebrow': { text: 'My part' },
      '.portfolio-section:last-child h2': { text: 'What I worked on' },
      '.portfolio-section:last-child .project-copy': { text: 'I contributed to the screen blanking program for tablets in vehicles. When the vehicle moves, the screen is blanked so the solution fits the safety context of the site.' },
  ...
  'index.html': {
    nl: {
      ...
      selectors: {
        ...
        '.neo-card:nth-child(1) h3': { text: 'Helpse' },
        '.neo-card:nth-child(1) p': { text: 'Een kanaal waar studenten mensen in de buurt kunnen helpen met klusjes tegen betaling.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.neo-card:nth-child(1) h3': { text: 'Helpse' },
        '.neo-card:nth-child(1) p': { text: 'A channel where students can help people nearby with paid small jobs.' },
        '.neo-card:nth-child(2) h3': { text: 'MissionZebra' },
  ...
  'projects.html': {
    nl: {
      ...
      selectors: {
        ...
        '.hub-grid-wrap h2': { text: 'Vijf projecten, vijf stappen vooruit' },
        '.hub-card:nth-child(1) h3': { text: 'Helpse' },
        '.hub-card:nth-child(1) p': { text: 'Een kanaal waar studenten mensen in de buurt kunnen helpen met klusjes tegen betaling.' },
    ...
    en: {
      ...
      selectors: {
        ...
        '.hub-grid-wrap h2': { text: 'Five projects, five steps forward' },
        '.hub-card:nth-child(1) h3': { text: 'Helpse' },
        '.hub-card:nth-child(1) p': { text: 'A channel where students can help people nearby with paid small jobs.' },
        '.hub-card:nth-child(2) h3': { text: 'MissionZebra' },
...
pageTranslations['project-two.html'] = {
  nl: {
    ...
    selectors: {
      ...
      '.project-hero h1': { text: 'MissionZebra' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'MissionZebra helpt gezinnen om opnieuw balans te vinden tussen schermtijd, taken en kwalitatieve tijd samen.' },
      '.hero-tags span:nth-child(1)': { text: 'Teamproject' },
      '.hero-tags span:nth-child(2)': { text: 'Gezinsbalans' },
      ...
      '.project-impact-grid article:nth-child(1) p': { text: 'Voor veel gezinnen zorgt stoppen met tablet of gsm voor discussie en stress.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Ouderzijde' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Ouders beheren taken, beloningen en gekoppelde apparaten via een duidelijk overzicht.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Kindzijde' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Kinderen zien taken, schermtijd en beloningen, waardoor schermtijd iets positiefs wordt.' },
      '.project-flow .eyebrow': { text: 'Aanpak' },
      '.project-flow h2': { text: 'Wat MissionZebra anders maakt' },
      '.project-steps li:nth-child(1)': { html: '<strong>Motivatie:</strong> MissionZebra focust niet op straffen of blokkeren, maar op afspraken en beloningen.' },
  ...
  en: {
    ...
    selectors: {
      '.project-hero .eyebrow': { text: 'MissionZebra' },
      '.project-hero h1': { text: 'MissionZebra' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'MissionZebra helps families find balance between screen time, tasks, and quality time together.' },
      '.hero-tags span:nth-child(1)': { text: 'Team project' },
      '.hero-tags span:nth-child(2)': { text: 'Family balance' },
      ...
      '.project-impact-grid article:nth-child(1) p': { text: 'For many families, stopping tablet or phone time creates stress and discussion.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Parent side' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Parents manage tasks, rewards, and connected devices through a clear overview.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Child side' },
      '.project-impact-grid article:nth-child(3) p': { text: 'Children see tasks, screen time, and rewards, making screen time something positive.' },
      '.project-flow .eyebrow': { text: 'Approach' },
      '.project-flow h2': { text: 'What makes MissionZebra different' },
      '.project-steps li:nth-child(1)': { html: '<strong>Motivation:</strong> MissionZebra focuses on agreements and rewards instead of punishment or blocking.' },
...
pageTranslations['project-helpse.html'] = {
  nl: {
    title: 'Seppe | Helpse',
    selectors: {
      '.project-hero .eyebrow': { text: 'Platformconcept' },
      '.project-hero h1': { text: 'Helpse' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Helpse is een platform waar studenten snel geld kunnen verdienen door kleine lokale jobs in hun buurt uit te voeren.' },
      '.hero-tags span:nth-child(1)': { text: 'React + Node.js' },
      '.hero-tags span:nth-child(2)': { text: 'Supabase' },
      '.hero-tags span:nth-child(3)': { text: 'Stripe' },
      '.hero-side-label': { text: 'Titel' },
      '.hero-side h3': { text: 'Verdien snel geld als student met kleine jobs' },
      '.project-impact .eyebrow': { text: 'Concept' },
      '.project-impact h2': { text: 'Hoe Helpse werkt' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Customers' },
      '.project-impact-grid article:nth-child(1) p': { text: 'Mensen die hulp nodig hebben kunnen taken posten en studenten accepteren.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Students' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Studenten bekijken lokale jobs, melden zich aan en voeren taken uit om geld te verdienen.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Premium toegang' },
  ...
  en: {
    title: 'Seppe | Helpse',
    selectors: {
      '.project-hero .eyebrow': { text: 'Platform concept' },
      '.project-hero h1': { text: 'Helpse' },
      '.project-hero .hero-main > p:not(.eyebrow)': { text: 'Helpse is a platform where students can quickly earn money by doing small local jobs nearby.' },
      '.hero-tags span:nth-child(1)': { text: 'React + Node.js' },
      '.hero-tags span:nth-child(2)': { text: 'Supabase' },
      '.hero-tags span:nth-child(3)': { text: 'Stripe' },
      '.hero-side-label': { text: 'Title' },
      '.hero-side h3': { text: 'Earn money fast as a student with small jobs' },
      '.project-impact .eyebrow': { text: 'Concept' },
      '.project-impact h2': { text: 'How Helpse works' },
      '.project-impact-grid article:nth-child(1) h3': { text: 'Customers' },
      '.project-impact-grid article:nth-child(1) p': { text: 'People who need help can post tasks and accept students.' },
      '.project-impact-grid article:nth-child(2) h3': { text: 'Students' },
      '.project-impact-grid article:nth-child(2) p': { text: 'Students browse local jobs, apply, and complete tasks to earn money.' },
      '.project-impact-grid article:nth-child(3) h3': { text: 'Premium access' },
